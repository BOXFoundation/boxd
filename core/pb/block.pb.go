...
func (*BlockHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_block_916b41fecde61dfd, []int{0}
}
...
func (*IrreversibleInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_block_916b41fecde61dfd, []int{1}
}
...
func (dst *IrreversibleInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IrreversibleInfo.Merge(dst, src)
}
...
type Block struct {
	...
	IrreversibleInfo []*IrreversibleInfo `protobuf:"bytes,5,rep,name=irreversible_info,json=irreversibleInfo" json:"irreversible_info,omitempty"`
}
...
func (*Block) Descriptor() ([]byte, []int) {
	return fileDescriptor_block_916b41fecde61dfd, []int{2}
}
...
func (*Transaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_block_916b41fecde61dfd, []int{3}
}
...
func (*TxIn) Descriptor() ([]byte, []int) {
	return fileDescriptor_block_916b41fecde61dfd, []int{4}
}
...
func (*TxOut) Descriptor() ([]byte, []int) {
	return fileDescriptor_block_916b41fecde61dfd, []int{5}
}
...
func (*OutPoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_block_916b41fecde61dfd, []int{6}
}
...
func (*Data) Descriptor() ([]byte, []int) {
	return fileDescriptor_block_916b41fecde61dfd, []int{7}
}
...
func (*UtxoWrap) Descriptor() ([]byte, []int) {
	return fileDescriptor_block_916b41fecde61dfd, []int{8}
}
...
func (m *Block) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.IrreversibleInfo) > 0 {
		for _, msg := range m.IrreversibleInfo {
			dAtA[i] = 0x2a
			i++
			i = encodeVarintBlock(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *Block) Size() (n int) {
	...
	if len(m.IrreversibleInfo) > 0 {
		for _, e := range m.IrreversibleInfo {
			l = e.Size()
			n += 1 + l + sovBlock(uint64(l))
		}
	}
...
func (m *Block) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.IrreversibleInfo = append(m.IrreversibleInfo, &IrreversibleInfo{})
			if err := m.IrreversibleInfo[len(m.IrreversibleInfo)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() { proto.RegisterFile("block.proto", fileDescriptor_block_916b41fecde61dfd) }

var fileDescriptor_block_916b41fecde61dfd = []byte{
	// 672 bytes of a gzipped FileDescriptorProto
	,
}
