...
type BlockHeader struct {
	...
	ExtraTxsRoot   []byte `protobuf:"bytes,4,opt,name=extra_txs_root,json=extraTxsRoot,proto3" json:"extra_txs_root,omitempty"`
	...
	PeriodHash     []byte `protobuf:"bytes,7,opt,name=period_hash,json=periodHash,proto3" json:"period_hash,omitempty"`
	CandidatesHash []byte `protobuf:"bytes,8,opt,name=candidates_hash,json=candidatesHash,proto3" json:"candidates_hash,omitempty"`
	RootHash       []byte `protobuf:"bytes,9,opt,name=root_hash,json=rootHash,proto3" json:"root_hash,omitempty"`
...
func (m *BlockHeader) GetExtraTxsRoot() []byte {
	if m != nil {
		return m.ExtraTxsRoot
	}
	return nil
}
...
type Block struct {
	...
	ExtraTxs         []*Transaction    `protobuf:"bytes,3,rep,name=extra_txs,json=extraTxs,proto3" json:"extra_txs,omitempty"`
...
func (m *Block) GetExtraTxs() []*Transaction {
	if m != nil {
		return m.ExtraTxs
	}
	return nil
...
var fileDescriptor_8e550b1f5926e92d = []byte{
	...
	,
}
...
func (m *BlockHeader) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ExtraTxsRoot) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintBlock(dAtA, i, uint64(len(m.ExtraTxsRoot)))
		i += copy(dAtA[i:], m.ExtraTxsRoot)
	}
	if m.TimeStamp != 0 {
		dAtA[i] = 0x28
		i++
...
func (m *BlockHeader) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExtraTxsRoot", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExtraTxsRoot = append(m.ExtraTxsRoot[:0], dAtA[iNdEx:postIndex]...)
			if m.ExtraTxsRoot == nil {
				m.ExtraTxsRoot = []byte{}
			}
			iNdEx = postIndex
		case 5:
...
func (m *Block) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExtraTxs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExtraTxs = append(m.ExtraTxs, &Transaction{})
			if err := m.ExtraTxs[len(m.ExtraTxs)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
