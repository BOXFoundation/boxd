...
func (c *sha256hash) RequiredGas(input []byte) uint64 {
	return uint64(len(input)+31)/32*types.Sha256PerWordGas + types.Sha256BaseGas
}
...
func (c *ripemd160hash) RequiredGas(input []byte) uint64 {
	return uint64(len(input)+31)/32*types.Ripemd160PerWordGas + types.Ripemd160BaseGas
}
...
func (c *dataCopy) RequiredGas(input []byte) uint64 {
	return uint64(len(input)+31)/32*types.IdentityPerWordGas + types.IdentityBaseGas
}
...
func (c *bigModExp) RequiredGas(input []byte) uint64 {
	...
	gas.Div(gas, new(big.Int).SetUint64(types.ModExpQuadCoeffDiv))
...
func (c *bn256ScalarMul) RequiredGas(input []byte) uint64 {
	return types.Bn256ScalarMulGas
}
...
func (c *bn256Pairing) RequiredGas(input []byte) uint64 {
	return types.Bn256PairingBaseGas + uint64(len(input)/192)*types.Bn256PairingPerPointGas
}
