...
type TxDetailRes int32

const (
	TxDetail_coinbase         TxDetailRes = 0
	TxDetail_external_account TxDetailRes = 1
	TxDetail_contract_account TxDetailRes = 2
)

var TxDetailRes_name = map[int32]string{
	0: "coinbase",
	1: "external_account",
	2: "contract_account",
}

var TxDetailRes_value = map[string]int32{
	"coinbase":         0,
	"external_account": 1,
	"contract_account": 2,
}

func (x TxDetailRes) String() string {
	return proto.EnumName(TxDetailRes_name, int32(x))
}

func (TxDetailRes) EnumDescriptor() ([]byte, []int) {
...
type TxDetail struct {
	Hash     string         `protobuf:"bytes,1,opt,name=hash,proto3" json:"hash,omitempty"`
	Resource TxDetailRes    `protobuf:"varint,2,opt,name=resource,proto3,enum=rpcpb.TxDetailRes" json:"resource,omitempty"`
...
func (m *TxDetail) GetResource() TxDetailRes {
	if m != nil {
		return m.Resource
	}
	return TxDetail_coinbase
}
...
func init() {
	...
	proto.RegisterEnum("rpcpb.TxDetailRes", TxDetailRes_name, TxDetailRes_value)
...
var fileDescriptor_461bb3ac99194e85 = []byte{
	...
	,
}
...
func (m *TxDetail) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Resource != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintWeb(dAtA, i, uint64(m.Resource))
	}
	if len(m.Vin) > 0 {
...
func (m *TxOutDetail_ContractInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ContractInfo != nil {
		...
		n8, err8 := m.ContractInfo.MarshalTo(dAtA[i:])
		if err8 != nil {
			return 0, err8
		}
		i += n8
...
func (m *TokenIssueInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TokenTag != nil {
		...
		n9, err9 := m.TokenTag.MarshalTo(dAtA[i:])
		if err9 != nil {
			return 0, err9
		}
		i += n9
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Resource |= TxDetailRes(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
