...
type TxInDetail struct {
	...
	PrevOutPoint  *pb.OutPoint `protobuf:"bytes,4,opt,name=prev_out_point,json=prevOutPoint,proto3" json:"prev_out_point,omitempty"`
}
...
func (m *TxInDetail) GetScriptSig() []byte {
	if m != nil {
		return m.ScriptSig
	}
	return nil
...
func (m *TxInDetail) GetPrevOutPoint() *pb.OutPoint {
	if m != nil {
...
func (m *TxOutDetail) GetScriptPubKey() []byte {
	if m != nil {
...
type BlockDetail struct {
	...
	CoinBase      string      `protobuf:"bytes,6,opt,name=coin_base,json=coinBase,proto3" json:"coin_base,omitempty"`
	Confirmed     bool        `protobuf:"varint,7,opt,name=confirmed,proto3" json:"confirmed,omitempty"`
	Signature     []byte      `protobuf:"bytes,8,opt,name=signature,proto3" json:"signature,omitempty"`
	Txs           []*TxDetail `protobuf:"bytes,9,rep,name=txs,proto3" json:"txs,omitempty"`
}
...
func (m *BlockDetail) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
type TokenIssueInfo struct {
	TokenTag *pb.TokenTag `protobuf:"bytes,2,opt,name=token_tag,json=tokenTag,proto3" json:"token_tag,omitempty"`
}
...
func (m *TokenIssueInfo) GetTokenTag() *pb.TokenTag {
	if m != nil {
		return m.TokenTag
	}
	return nil
...
type TokenTransferInfo struct {
	TokenId *pb.OutPoint `protobuf:"bytes,1,opt,name=token_id,json=tokenId,proto3" json:"token_id,omitempty"`
}
...
func (m *TokenTransferInfo) GetTokenId() *pb.OutPoint {
	if m != nil {
		return m.TokenId
	}
	return nil
...
var fileDescriptor_461bb3ac99194e85 = []byte{
	...
	,
}
...
func (m *TokenTransferInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TokenId != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintWeb(dAtA, i, uint64(m.TokenId.Size()))
		n10, err := m.TokenId.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
