...
func (*ListUtxosRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_21bde65b043cd3af, []int{0}
}
...
func (*FundTransactionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_21bde65b043cd3af, []int{1}
}
...
func (*SendTransactionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_21bde65b043cd3af, []int{2}
}
...
func (*ListUtxosResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_21bde65b043cd3af, []int{3}
}
...
func init() { proto.RegisterFile("transaction.proto", fileDescriptor_transaction_21bde65b043cd3af) }

var fileDescriptor_transaction_21bde65b043cd3af = []byte{
	...
	,
}
