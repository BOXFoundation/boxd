...
func request_TransactionCommand_GetGasPrice_0(ctx context.Context, marshaler runtime.Marshaler, client TransactionCommandClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetGasPriceRequest
	var metadata runtime.ServerMetadata
...
func RegisterTransactionCommandHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TransactionCommandClient) error {
	...
	mux.Handle("POST", pattern_TransactionCommand_GetGasPrice_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req)
		...
		resp, md, err := request_TransactionCommand_GetGasPrice_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_TransactionCommand_GetGasPrice_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_TransactionCommand_GetGasPrice_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "tx", "getgasprice"}, ""))
)
...
var (
	...
	forward_TransactionCommand_GetGasPrice_0 = runtime.ForwardResponseMessage
)
