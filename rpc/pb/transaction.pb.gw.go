...
var (
	...
	pattern_TransactionCommand_MakeUnsignedSplitAddrTx_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "tx", "makeunsignedsplitaddrtx"}, ""))

	pattern_TransactionCommand_MakeUnsignedTokenIssueTx_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "tx", "makeunsignedtokenissuetx"}, ""))
)
