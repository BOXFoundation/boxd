...
import fmt "fmt"
import math "math"
import corepb "github.com/BOXFoundation/boxd/core/pb"
...
func (*LocateHeaders) Descriptor() ([]byte, []int) {
	return fileDescriptor_sync_c68e3c95f6143d34, []int{0}
}
...
func (*SyncHeaders) Descriptor() ([]byte, []int) {
	return fileDescriptor_sync_c68e3c95f6143d34, []int{1}
}
...
func (*CheckHash) Descriptor() ([]byte, []int) {
	return fileDescriptor_sync_c68e3c95f6143d34, []int{2}
}
...
func (*SyncCheckHash) Descriptor() ([]byte, []int) {
	return fileDescriptor_sync_c68e3c95f6143d34, []int{3}
}
...
func (*FetchBlockHeaders) Descriptor() ([]byte, []int) {
	return fileDescriptor_sync_c68e3c95f6143d34, []int{4}
}
...
type SyncBlocks struct {
	Idx    int32           `protobuf:"varint,1,opt,name=idx,proto3" json:"idx,omitempty"`
	Blocks []*corepb.Block `protobuf:"bytes,2,rep,name=blocks" json:"blocks,omitempty"`
}
...
func (*SyncBlocks) Descriptor() ([]byte, []int) {
	return fileDescriptor_sync_c68e3c95f6143d34, []int{5}
}
...
func (m *SyncBlocks) GetBlocks() []*corepb.Block {
	if m != nil {
		return m.Blocks
	}
	return nil
...
func init() { proto.RegisterFile("sync.proto", fileDescriptor_sync_c68e3c95f6143d34) }

var fileDescriptor_sync_c68e3c95f6143d34 = []byte{
	// 312 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0x84, 0x91, 0x4f, 0x4b, 0xc3, 0x30,
	0x18, 0xc6, 0x97, 0x95, 0x15, 0xfb, 0x6e, 0x03, 0xdd, 0x61, 0x14, 0xc5, 0x50, 0x0a, 0xc3, 0x1e,
	...
	,
}
